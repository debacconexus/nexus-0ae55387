...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "ED Flow Command";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "ED Patient Encounter";
process.env.TABLE_NAME = process.env.TABLE_NAME || "ed_patient_encounter_records";
'use strict';
